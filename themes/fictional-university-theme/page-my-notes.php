...
while (have_posts()) {
    ...
    <div class="container container--narrow page-section">
        <div class="create-note">
            ...
            <span class="submit-note">Create one</span>
        ...
        <ul class="min-list link-list" id="my-notes">
            ...
            $userNotes = new WP_Query(array(
                'post_type' => 'note',
                'posts_per_page' => -1,
                'author' => get_current_user_id(), // Corrected line
            ));
            ...
            while ($userNotes->have_posts()) {
                ...
                <li data-id="<?the_ID()?>">
                    ...
                    <span class="edit-note"><i class="fa fa-pencil" area-hidden="true"></i>Edit note</span>
                    <span class="delete-note"><i class="fa fa-trash" area-hidden="true"></i>Delete note</span>
