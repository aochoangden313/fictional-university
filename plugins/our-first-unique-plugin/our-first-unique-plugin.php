...
class WordCountAndTimePlugin {
    ...
    function createHTML($content) {
        $html = '<h3>' . get_option('wcp_headline', 'Post Satistics') . '</h3><p>';
        ...
        if (get_option('wcp_wordcount','1')) {
            $html .= esc_html__('This post has', 'wcpdomain').' '. $wordCount . ' '.esc_html__('word(s)', 'wcpdomain').'<br>';
        }

        if (get_option('wcp_charactercount','1')) {
            $html .= 'This post has '. strlen(strip_tags($content)) . ' character(s)<br>';
        }
    ...
    function settings () {
        ...
        add_settings_field('wcp_wordcount', 'Read Time', array($this, 'checkboxHTML'), 'word-count-settings-page', 'wcp_first_section', array('theName' => 'wcp_wordcount'));
        ...
        add_settings_field('wcp_charactercount', 'Read Time', array($this, 'checkboxHTML'), 'word-count-settings-page', 'wcp_first_section', array('theName' => 'wcp_charactercount'));
    ...
    */
    ...
    function sanitizeLocation($input) {
        if ($input != '0' AND $input != '1') {
            add_settings_error('wcp_location', 'wcp_location_error','Display loction must be either beggining or end');
