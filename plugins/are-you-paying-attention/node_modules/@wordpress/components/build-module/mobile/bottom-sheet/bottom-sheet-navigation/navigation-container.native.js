...
function BottomSheetNavigationContainer({
  ...
  const screens = useMemo(() => {
    return Children.map(children, child => {
      ...
      return /*#__PURE__*/_jsx(Stack.Screen, {
        name: name,
        ...otherProps,
        children: () => screen
      });
  ...
  return useMemo(() => {
    return /*#__PURE__*/_jsx(Animated.View, {
      ...
      testID: testID,
      children: /*#__PURE__*/_jsx(BottomSheetNavigationProvider, {
        value: {
          setHeight,
          currentHeight
        },
        children: main ? /*#__PURE__*/_jsx(NavigationContainer, {
          theme: _theme,
          children: /*#__PURE__*/_jsx(Stack.Navigator, {
