...
function UnconnectedZStack(props, forwardedRef) {
  ...
  const clonedChildren = validChildren.map((child, index) => {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.ZStackChildView, {
      offsetAmount: offsetAmount,
      zIndex: zIndex,
      children: child
    }, key);
  });
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_styles.ZStackView, {
    ...otherProps,
    className: className,
    isLayered: isLayered,
    ref: forwardedRef,
 ...
 * ```
 */
const ZStack = exports.ZStack = (0, _context.contextConnect)(UnconnectedZStack, 'ZStack');
var _default = exports.default = ZStack;
