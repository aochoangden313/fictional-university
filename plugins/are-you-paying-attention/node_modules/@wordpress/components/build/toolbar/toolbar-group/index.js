...
function ToolbarGroup({
  ...
  const finalClassName = (0, _clsx.default)(
  ...
  if (isCollapsed) {
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_toolbarGroupCollapsed.default, {
      label: title,
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_toolbarGroupContainer.default, {
    className: finalClassName,
    ...props,
    children: [controlSets?.flatMap((controlSet, indexOfSet) => controlSet.map((control, indexOfControl) => /*#__PURE__*/(0, _jsxRuntime.jsx)(_toolbarButton.default, {
