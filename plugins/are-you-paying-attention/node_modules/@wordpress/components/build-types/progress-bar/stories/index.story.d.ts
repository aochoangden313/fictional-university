 ...
 * ```
 */
export declare const WithCustomWidth: import("@storybook/csf").AnnotatedStoryFn<import("@storybook/react").ReactRenderer, import("../types").ProgressBarProps & Omit<Omit<import("react").DetailedHTMLProps<import("react").ProgressHTMLAttributes<HTMLProgressElement>, HTMLProgressElement>, "ref">, "children" | "as" | keyof import("../types").ProgressBarProps> & import("react").RefAttributes<HTMLProgressElement>>;
