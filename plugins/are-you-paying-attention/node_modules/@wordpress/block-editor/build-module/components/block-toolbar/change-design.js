 ...
 */
import { ToolbarButton, ToolbarGroup, Dropdown, __experimentalDropdownContentWrapper as DropdownContentWrapper } from '@wordpress/components';
...
export default function ChangeDesign({
  clientId
}) {
  const {
    categories,
