...
import { serialize, createBlock, pasteHandler, findTransform, getBlockTransforms, store as blocksStore } from '@wordpress/blocks';
...
export function setClipboardBlocks(event, blocks, registry) {
  ...
  if (firstBlock) {
    ...
    if (firstBlockType[requiresWrapperOnCopy]) {
      ...
      if (wrapperBlockName) {
        _blocks = createBlock(wrapperBlockName, getBlockAttributes(wrapperBlockClientId), _blocks);
      }
    }
  }
