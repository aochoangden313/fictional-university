...
function getValueFromVariable(features, blockName, variable) {
  if (!variable || typeof variable !== 'string') {
    if (typeof variable?.ref === 'string') {
      variable = (0, _object.getValueFromObjectPath)(features, variable.ref);
...
function getResolvedRefValue(ruleValue, tree) {
  ...
  if (typeof ruleValue !== 'string' && ruleValue?.ref) {
    const resolvedRuleValue = (0, _styleEngine.getCSSValueFromRawStyle)((0, _object.getValueFromObjectPath)(tree, ruleValue.ref));
