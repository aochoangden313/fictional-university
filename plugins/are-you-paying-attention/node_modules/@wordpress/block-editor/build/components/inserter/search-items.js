...
exports.getNormalizedSearchTerms = void 0;
exports.normalizeString = normalizeString;
exports.searchItems = exports.searchBlockItems = void 0;
...
function extractWords(input = '') {
  ...
  const result = (0, _changeCase.noCase)(input, {
    splitRegexp,
    stripRegexp
...
function normalizeString(input = '') {
  ...
  //  Input: "média"
  let result = (0, _removeAccents.default)(input);
