...
const __unstableSetEditorMode = mode => ({
  ...
  registry.dispatch(_preferences.store).set('core', 'editorTool', mode);
  if (mode === 'navigation') {
    (0, _a11y.speak)((0, _i18n.__)('You are currently in Write mode.'));
  } else if (mode === 'edit') {
    (0, _a11y.speak)((0, _i18n.__)('You are currently in Design mode.'));
  }
};
