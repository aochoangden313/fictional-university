...
function isOfType(value, type) {
  switch (type) {
    case 'rich-text':
      return value instanceof _richText.RichTextData;
    case 'string':
...
function getBlockAttribute(attributeKey, attributeSchema, innerDOM, commentAttributes, innerHTML) {
  ...
  if (value === undefined) {
    value = (0, _utils.getDefault)(attributeSchema);
  }
  return value;
}
 ...
 */
const matcherFromSource = exports.matcherFromSource = (0, _memize.default)(sourceConfig => {
  switch (sourceConfig.source) {
    ...
    case 'rich-text':
      return (0, _matchers.richText)(sourceConfig.selector, sourceConfig.__unstablePreserveWhiteSpace);
    case 'children':
    ...
    case 'tag':
      {
        const matcher = (0, _matchers.prop)(sourceConfig.selector, 'nodeName');
